...
BEGIN
	...
	CALL SP_INSERT_Empleado(@IdEmpleado,_Nombre,_APaterno,_AMaterno,_Fecha_nacimiento,_Sexo,_Calle,_Numero,_Telefono,_Celular,_Correo,_IdAcentamiento,1000,Grado_estudios);
