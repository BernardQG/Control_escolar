...
BEGIN
	...
	SELECT U.IdUsuario,U.IdEmpleado,U.Usuario,AES_DECRYPT(Password,_Llave) as 'Password',H.Correo as Correo FROM Usuario AS U
	INNER JOIN Empleado AS E ON U.IdEmpleado=E.IdEmpleado
	INNER JOIN Humano AS H ON E.IdHumano = H.IdHumano
	WHERE
	U.Usuario =_Usuario AND U.Estatus=1;
